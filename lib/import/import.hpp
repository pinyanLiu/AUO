...
class IMPORT
{
    ...
    public:
        IMPORT(const std::string iP,const std::string name,const std::string passwd,const std::string database);
        EXPERIMENTAL_PARAMETERS get_experimental_parameters();//EP for EXPERIMENTAL_PARAMETERS
        PLAN_FLAG get_plan_flag();//PF for PLAN_FLAG
